...
//         Vector2<float> GetMousePosition(); // Method to return the Vector2 of the mouse.
//         Vector2<float> GetMouseLastPosition(); // Method to return the Vector2 of mouse's last position.
//
//     private:
...
//         Vector2<float> mousePosition; // Vector2 defining current mouse position
//         Vector2<float> mouseLastPosition; // Vector2 defining last mouse position
