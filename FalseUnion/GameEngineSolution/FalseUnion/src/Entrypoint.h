...
int main(int argc, char** argv)
{
    ...
    auto logger = FalseUnion::CreateLogger(); // uses client to create logger
    FalseUnion::Logger::setLoggerInstance(logger); // sets the logger instance to the client created logger.
